...
namespace Sphynx.Network.PacketV2.Request
{
    ...
    public sealed class RoomLeaveRequestPacket : SphynxRequestPacket, IEquatable<RoomLeaveRequestPacket>
    {
        ...
        public RoomLeaveRequestPacket(Guid roomId) : this(SnowflakeId.Empty, Guid.Empty, roomId)
        {
        }
        ...
        /// <param name="roomId">Room ID of the room to leave.</param>
        public RoomLeaveRequestPacket(SnowflakeId userId, Guid sessionId, Guid roomId) : base(userId, sessionId)
        {
            RoomId = roomId;
        }
