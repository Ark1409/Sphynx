...
namespace Sphynx.Network.PacketV2.Request
{
    ...
    public sealed class FetchMessagesRequest : SphynxRequest<FetchMessagesResponse>, IEquatable<FetchMessagesRequest>
    {
        ...
        public FetchMessagesRequest(Guid sessionId) : base(sessionId)
        {
        }
        ...
        /// response.</param>
        public FetchMessagesRequest(Guid sessionId, SnowflakeId beforeId, Guid roomId, int count, bool inclusive = false)
            : base(sessionId)
        {
            BeforeId = beforeId;
            Count = count;
