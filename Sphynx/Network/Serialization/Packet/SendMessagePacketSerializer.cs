...
namespace Sphynx.Network.Serialization.Packet
{
    ...
    {
        protected override int GetMaxPacketSizeInternal(SendMessageRequestPacket packet)
        {
    ...
    {
        protected override int GetMaxPacketSize(SendMessageBroadcastPacket packet)
        {
