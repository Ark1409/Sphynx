...
using SphynxPacketHandler = Sphynx.Server.Infrastructure.Handlers.IPacketHandler<Sphynx.Network.Packet.SphynxPacket>;
using SphynxPacketMiddleware = Sphynx.Server.Infrastructure.Middleware.IPacketMiddleware<Sphynx.Network.Packet.SphynxPacket>;
